...
public class SecondDestination extends AppCompatActivity implements FABProgressListener, MockActionCallback {
    ...
    SecondDestination CameraActivity = null;
    final int MY_PERMISSIONS_REQUEST_READ_CONTACTS = 1;
    String TAG = "SecondDestination";
...
//            imageDetails = (TextView) findViewById(R.id.imageDetails);
        ...
        showImg.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(SecondDestination.this,
                        Manifest.permission.WRITE_EXTERNAL_STORAGE)
                        != PackageManager.PERMISSION_GRANTED) {

                    // Should we show an explanation?
                    if (ActivityCompat.shouldShowRequestPermissionRationale(SecondDestination.this,
                            Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                        ...
                        ActivityCompat.requestPermissions(SecondDestination.this,
...
//            setText("Start playing");
    ...
    public class LoadImagesFromSDCard extends AsyncTask<String, Void, Void> {
        ...
        private ProgressDialog Dialog = new ProgressDialog(SecondDestination.this);
